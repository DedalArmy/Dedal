...
/**
 * This is the item provider adapter for a {@link dedal.Port} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PortItemProvider extends InteractionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_interfaces_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_interfaces_feature", "_UI_Port_type"),
				 DedalPackage.Literals.PORT__INTERFACES,
				 true,
				 false,
				 true,
				 null,
