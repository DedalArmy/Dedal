...
/**
 * This is the item provider adapter for a {@link dedal.Repository} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepositoryItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DedalPackage.Literals.REPOSITORY__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DedalPackage.Literals.REPOSITORY__COMPONENTS);
			childrenFeatures.add(DedalPackage.Literals.REPOSITORY__INTERFACE_TYPES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DedalPackage.Literals.REPOSITORY__COMPONENTS,
				 DedalFactory.eINSTANCE.createCompRole()));
		...
		newChildDescriptors.add
			(createChildParameter
				(DedalPackage.Literals.REPOSITORY__INTERFACE_TYPES,
				 DedalFactory.eINSTANCE.createInterfaceType()));
	}
