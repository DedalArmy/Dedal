...
/**
 * This is the item provider adapter for a {@link dedal.Specification} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SpecificationItemProvider extends ArchitectureDescriptionItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DedalPackage.Literals.SPECIFICATION__SPEC_COMPONENTS);
			childrenFeatures.add(DedalPackage.Literals.SPECIFICATION__SPEC_CONNECTIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DedalPackage.Literals.SPECIFICATION__SPEC_COMPONENTS,
				 DedalFactory.eINSTANCE.createCompRole()));

		newChildDescriptors.add
			(createChildParameter
				(DedalPackage.Literals.SPECIFICATION__SPEC_CONNECTIONS,
				 DedalFactory.eINSTANCE.createRoleConnection()));
	}
