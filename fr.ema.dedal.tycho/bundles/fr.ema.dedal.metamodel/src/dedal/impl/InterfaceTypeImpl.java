 ...
 * </p>
 * <ul>
 *   <li>{@link dedal.impl.InterfaceTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link dedal.impl.InterfaceTypeImpl#getSignatures <em>Signatures</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InterfaceTypeImpl extends MinimalEObjectImpl.Container implements InterfaceType {
	...
	protected EClass eStaticClass() {
		return DedalPackage.Literals.INTERFACE_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DedalPackage.INTERFACE_TYPE__NAME, oldName, name));
	}
	...
	public EList<Signature> getSignatures() {
		if (signatures == null) {
			signatures = new EObjectContainmentEList<Signature>(Signature.class, this, DedalPackage.INTERFACE_TYPE__SIGNATURES);
		}
		return signatures;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DedalPackage.INTERFACE_TYPE__SIGNATURES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DedalPackage.INTERFACE_TYPE__NAME:
				return getName();
			case DedalPackage.INTERFACE_TYPE__SIGNATURES:
